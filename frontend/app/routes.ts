...
export default [
  ...
  route('boogi-out/create', 'routes/boogi-out.create.tsx'),
  route('boogi-out/:id/proof/:token', 'routes/boogi-out.$id.proof.$token.tsx'),
  route('boogi-out/:id', 'routes/boogi-out.$id.tsx'),
  route('boogi-out', 'routes/boogi-out.tsx'),
  ...
  route('room', 'routes/room.selector.tsx'),
